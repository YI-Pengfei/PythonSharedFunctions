"""
IATA code, for grab_Ctrip.py
"""
dict_cities = {'阿尔山': 'YIE', '阿克苏': 'AKU', '阿拉善右旗': 'RHT', '阿拉善左旗': 'AXF', '阿勒泰': 'AAT', '阿里': 'NGQ', '澳门': 'MFM', 
	...
	'长治': 'CIH', '承德': 'CDE', '沧源': 'CWJ',  '大理': 'DLU', '大连': 'DLC', '大庆': 'DQA', '大同': 'DAT', 
	...
	'伊宁市': 'YIN', '宜宾': 'YBP', '宜昌': 'YIH', '宜春': 'YIC', '义乌': 'YIW', '银川': 'INC', '永州': 'LLF', '榆林': 'UYN', '玉树': 'YUS', 
	'运城': 'YCU', '湛江': 'ZHA', '张家界': 'DYG', '张家口': 'ZQZ', '张掖': 'YZY', '昭通': 'ZAT', '郑州': 'CGO', '中卫': 'ZHY', '舟山': 'HSN', 
	'珠海': 'ZUH', 
    '遵义茅台': 'WMT', '遵义': 'ZYI',
    '顺德': 'NDH', '霍林郭勒':'HUO', '陇南':'LNL', '邵阳':'WGN', '通化':'TNH', '衡阳':'HNY', '营口':'YKH', 
    '莎车': 'QSZ', '若羌':'RQA', '花土沟':'HTT', '红原':'AHJ', '祁连':'HBQ', '石河子':'SHF', '河池':'HCJ', '江门': 'JBD',
    '果洛': 'GMQ', '松原':'YSQ', '新源':'NLT', '扎兰屯':'NZL', '忻州':'WUT', '德令哈':'HXD', '布尔津':'KJI', '巴中':'BJX', '巫山':'WSK',
    '岳阳':'YYA', '富蕴':'FYN', '夏河':'GXH', '图木舒克':'TWC', '十堰':'WDS', '信阳':'XAI', '五大连池':'DTU', '乌兰察布':'UCB', 
    '上饶':'SQD', '三明':'SQJ',
    #'香格里拉(迪庆)': 'DIG',
    '迪庆':'DIG', 
    '达县': 'DAX', '达州':'DAX',
